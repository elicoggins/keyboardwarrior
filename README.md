...
| Platform | File |
| --- | --- |
| macOS (Apple Silicon **and** Intel) | [`KeyboardWarrior-1.0.2-macOS-universal.zip`](https://github.com/elicoggins/keyboardwarrior/releases/download/v1.0.2/KeyboardWarrior-1.0.2-macOS-universal.zip) |
| Windows (x86-64) | [`KeyboardWarrior-1.0.2-windows-x86_64.zip`](https://github.com/elicoggins/keyboardwarrior/releases/download/v1.0.2/KeyboardWarrior-1.0.2-windows-x86_64.zip) |
| Linux (x86-64) | [`KeyboardWarrior-1.0.2-linux-x86_64.tar.gz`](https://github.com/elicoggins/keyboardwarrior/releases/download/v1.0.2/KeyboardWarrior-1.0.2-linux-x86_64.tar.gz) |
