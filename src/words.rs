...
const WORDS_BY_LEN: [&[&str]; 8] = [
    ...
    &[
        ...
        "purple", "puzzle", "rabbit", "raisin", "ripple", "rocket", "rubber", "saddle", "salmon",
        "shadow", "shrimp", "signal", "sonnet", "spider", "spiral", "splash", "spring", "sprout",
        "squash", "stable", "stereo", "stitch", "stormy", "stream", "string", "sturdy", "subtle",
        "sunset", "temple", "tender", "thrive", "timber", "tomato", "trophy", "turtle", "tuxedo",
        "twelve", "valley", "velvet", "violet", "violin", "voyage", "waffle", "walnut", "walrus",
        "wander", "wallet", "warmth", "willow", "winter", "wisdom", "wizard", "wonder", "yogurt",
        "zigzag",
    ],
    &[
